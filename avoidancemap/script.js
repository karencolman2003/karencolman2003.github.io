...
const MAP_IMAGE_PATH = "assets/smith-campus-map.png";

// Percentage coordinates keep the overlay responsive and easy to tune by hand.
const buildingPositions = {
  "Neilson Library": { x: 42, y: 36 },
  "Campus Center": { x: 54, y: 44 },
  "Seelye Hall": { x: 48, y: 40 },
  "Sabin-Reed Hall": { x: 63, y: 38 },
  "Ford Hall": { x: 66, y: 35 },
  "Wright Hall": { x: 58, y: 39 },
  "Burton Hall": { x: 69, y: 41 },
  "Young Science Library": { x: 72, y: 37 },
  "Schacht Center": { x: 35, y: 58 },
  "Scott Gymnasium": { x: 28, y: 61 },
  "Sage Hall": { x: 22, y: 46 },
  "Chapin House": { x: 39, y: 22 },
  "Lamont House": { x: 36, y: 19 },
  "Cutter House": { x: 32, y: 24 },
  "Northrop House": { x: 29, y: 28 },
  "John M. Greene Hall": { x: 24, y: 49 },
  "Museum of Art": { x: 18, y: 43 },
  "Stoddard Hall": { x: 14, y: 39 }
};
